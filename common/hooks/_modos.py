...
MODOS = {
    "exploracao": {
        ...
        "gate": "parcial — o painel existe, o veredito não",
    },
    "descoberta": {
        ...
        "gate": "existe (topologia discovery), mas ainda não cobra os critérios",
    },
    "design": {
    ...
    "reflexao": {
        ...
        "gate": "reflexao-gate.py barra relatório fechado com achado solto",
    },
    "documentacao": {
