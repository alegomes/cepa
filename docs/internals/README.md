...
| [`path-lock.md`](path-lock.md) | Deep dive on the path-lock PreToolUse hook. Prefix scoping (the multi-plugin collision fix), agent detection, allowlist conventions, foreign-prefix and no-prefix early-exits, expertise-file structural check. |
